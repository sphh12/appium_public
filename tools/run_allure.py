...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="pytest 인자들 (예: -- tests/android/sample1_test.py -v --platform=android)",
    )
    ...
    if not pytest_args:
        print(
            "pytest 인자가 없습니다. 예: python tools/run_allure.py -- tests/android/sample1_test.py -v --platform=android"
        )
        return 2
