...
#   ./shell/run-aos.sh --sample1_test --test test_Login # 특정 테스트 메서드 실행
#   ./shell/run-aos.sh --stg --basic_01_test        # STG APK + 특정 테스트
#   ./shell/run-aos.sh --live --sample1_test           # Live APK + 특정 테스트
#   ./shell/run-aos.sh --livetest --sample1_test      # LiveTest APK + 특정 테스트
