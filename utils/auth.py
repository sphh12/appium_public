...
환경변수 설정:
  ...
  - APP_RESOURCE_ID_PREFIX: 앱의 resource-id 접두사
...
DEFAULT_RESOURCE_ID_PREFIX = _env_cfg["resource_id_prefix"]
DEFAULT_USERNAME = _env_cfg["username"]
DEFAULT_PIN = _env_cfg["password"]
...
def _is_staging_app(resource_id_prefix: str) -> bool:
    ...
    - Staging: 'com.example.remittance.stag:id' → 숫자 전용 보안 키보드
    - Live: 'com.example.remittance:id' → QWERTY 보안 키보드
    """
