...
- SSH (권장)
  - `git clone -b home --single-branch git@gitlab.com:your-username/appium-portfolio.git`

- HTTPS (회사 정책 등으로 SSH가 어려운 경우)
  - `git clone -b home --single-branch https://gitlab.com/your-username/appium-portfolio.git`
